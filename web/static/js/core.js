...
const TIPS = {
  ...
  'KD':          'KD（隨機指標，台股慣用 9 日 RSV + 2/3-1/3 遞迴平滑，與 goodinfo/XQ 等看盤軟體同一套公式）：K為快線，D為K的平滑值（慢線）。\nK < 20：超賣；K > 80：超買\nK從下往上穿越D：黃金交叉（買入訊號）\nK從上往下穿越D：死亡交叉（賣出訊號）',
  ...
  '毛利率':      '毛利率（Gross Margin）：（營收 - 銷貨成本）÷ 營收。反映產品定價能力與成本控制效率，適合同業互相比較。資料來源 yfinance，非所有個股/ETF 都有涵蓋。',
